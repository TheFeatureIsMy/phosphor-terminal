...
struct APIStrategyRuns {
    ...
    func listRuns(
        ...
        return try await client.get(path) {
            [
                StrategyRunV2(
                    id: UUID().uuidString,
                    strategyVersionId: UUID().uuidString,
                    mode: "dryrun",
                    status: "running",
                    ...
                    resultSummary: AnyCodable(["total_trades": 12, "win_rate": 0.67, "total_pnl": 245.80])
                ),
                StrategyRunV2(
                    id: UUID().uuidString,
                    strategyVersionId: UUID().uuidString,
                ...
                StrategyRunV2(
                    ...
                    stoppedAt: "2026-06-03T14:05:00Z",
    ...
    func getRunOrders(_ runId: String, limit: Int = 50) async throws -> [Order] {
        try await client.get("/api/v2/strategy-runs/\(runId)/orders?limit=\(limit)") {
            [
                Order(
                    id: 1001, strategyId: 1, symbol: "BTC/USDT", side: .buy,
                ...
                Order(
                    id: 1002, strategyId: 1, symbol: "BTC/USDT", side: .sell,
                ...
                Order(
                    id: 1003, strategyId: 1, symbol: "BTC/USDT", side: .buy,
        ...
        try await client.get("/api/v2/strategy-runs/\(runId)/ledger?limit=\(limit)") {
            [
                AnyCodable([
                    ...
                    "created_at": "2026-06-05T10:30:02Z",
                ] as [String: Any]),
                AnyCodable([
                    "id": UUID().uuidString,
                    "run_id": runId,
